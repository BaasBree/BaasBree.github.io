const STORAGE_KEY = window.GymLogStorage?.key || "gymlog.v3";
...
function loadState() {
  return window.GymLogStorage.load(defaultState, migrateState);
}
...
function saveState() {
  window.GymLogStorage.save(state);
}
...
function exportBackup() {
  window.GymLogStorage.exportBackup(state, todayKey);
